...
public class EventoServiceImpl implements IEventoService {
	...
	public List<Evento> findByFechaRango(Date inicio, Date fin) {
	 ...
	 @Override
	    public Evento findEventoSinSalidaHoy(Long id_usuario, LocalDate fecha) {
	        Date fechaInicio = Date.valueOf(fecha);
	        Date fechaFin = Date.valueOf(fecha.plusDays(1));

	        return EventoDao
	            .findFirstByIdUsuarioIdAndFechaingresoBetweenAndFechasalidaIsNull(id_usuario, fechaInicio, fechaFin)
	            .orElse(null);
	    }
